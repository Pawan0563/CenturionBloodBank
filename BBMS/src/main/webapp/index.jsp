...
<body>
	...
	<div style="max-width: 100%">
		<img class="mySlides" src="blood1.jpg"> <img class="mySlides"
			src="blood8.jpg">
			<img class="mySlides" src="blood4.jpg">
	</div>
	<script>
		var myIndex = 0;
		carousel();
...
<body>
	...
	<center>
		<font color="red" size="5">Form Submitted Successfully. You
			will get notified Within 24 hrs!!</font>
	</center>
	<%
	}
	%>
	...
	<center>
		<form action="indexFormAction.jsp" method="post">
			...
			<input type="text" name="mobilenumber"
				...
				type="mail" name="email" placeholder="Enter mail Addresh" required>
